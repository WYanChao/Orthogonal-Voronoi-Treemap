...
///////////////////////////////////////////
// 1. Load Points (Array of Array); 
// 2. Convert to Vector Point;
// 3. Calculate Convex Hull First;
// 4. Calculate OMBB;
// 5. Convert to Points (Array of Array);
function CalcOMBB(polygon) {
	// 1. Load Points (Array of Array);
	var OutputPolygon=[];
	...
	// 4. Calculate OMBB;
	var oobb = CalcOmbb(convexHull);
	//console.log(oobb);

	// 5. Convert to Points (Array of Array);
	oobb.forEach(function(d) {
		OutputPolygon.push([d.x, d.y]);
	});
